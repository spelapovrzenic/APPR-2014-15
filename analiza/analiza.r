...
plot(t[,3], t[,1], xlab="Porečje Save",ylab="Slovenija - skupaj")
plot(t[,10], t[,1], xlab="Krška-Sava",ylab="Slovenija - skupaj") 
plot(t[,14], t[,1],xlab="Porečje Save",ylab="Slovenija - skupaj")
plot(t[,35], t[,1],xlab="Idrijca",ylab="Slovenija - skupaj")
plot(t[,33], t[,28],xlab="Povodje Soče",ylab="Povodje Jadranskega morja")
